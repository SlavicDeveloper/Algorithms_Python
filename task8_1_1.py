...
def haffman_tree(s):
    """Функция составляет дерево по алгоритму Хаффмана"""
    ...
    # sorted_elements -
    # deque
    # ([({0: {0: 'b', 1: {0: ' ', 1: 'o'}}, 1: {0: {0: {0: 'r', 1: '!'}, 1: 'p'}, 1: 'e'}}, 15)])
    # {0: {0: 'b', 1: {0: ' ', 1: 'o'}}, 1: {0: {0: {0: 'r', 1: '!'}, 1: 'p'}, 1: 'e'}}
    # словарь - дерево
    return sorted_elements[0][0]


code_table = defaultdict(list)


# tree - {0: {0: 'b', 1: {0: ' ', 1: 'o'}}, 1: {0: {0: {0: 'r', 1: '!'}, 1: 'p'}, 1: 'e'}}

def haffman_code(tree, path=''):
    """Преобразование значений дерева в двоичный код"""
...
[print(code_table[i], end=" ") for i in s]
